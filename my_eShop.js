...
//
// const DEFAULT_ITEM =
//     {title: 'Title', img: 'img/blank.jpg', price: 0}
//
...
//
//
// window.onload = () => renderGoodsList();  //вызов функции с параметром по умолчанию, пустой массив => renderGoodsItem(object DEFAULT_ITEM)